    ...
    <section ref={ref} className="relative py-20 md:py-32 overflow-hidden">
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-radial from-purple-600/10 via-transparent to-transparent"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          animate={isInView ? { opacity: 1, scale: 1 } : {}}
          transition={{ duration: 1.5, ease: "easeOut", delay: 0.2 }}
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-radial from-cyan-500/5 via-transparent to-transparent"
        />
      </div>
      ...
      <div className="container-main relative z-10">
        ...
        >
          <motion.span
            ...
            className="inline-block px-3 py-1 text-xs font-medium tracking-wider text-purple-300 uppercase bg-purple-500/10 border border-purple-500/20 rounded-full mb-6"
          >
            Get Started Today
          </motion.span>
          ...
          <motion.div
            ...
            className="mt-10 flex items-center justify-center gap-6 text-sm text-zinc-600"
          >
